  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    try {
      ...
      if (!audioUrl || !imageUrl || !voiceType) {
        ...
        throw new Error("Please select an audio and an image");
      }
      await createPodcast({
      ...
      console.log(error);
      toast({
        title: "Error creating in creating the podcast",
        variant: "destructive",
      });
      setIsSubmitting(false);
    }
  ...
  return (
    <section className="mt-10 flex flex-col">
      ...
      <Form {...form}>
        ...
        >
          <div className="flex flex-col gap-[30px] border-b border-black-b pb-10">
            <FormField
